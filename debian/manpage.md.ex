% IRGSH-CLI(SECTION) | User Commands
%
% "24 Feb 2026"
...
irgsh-cli - short summary

# SYNOPSIS

**irgsh-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**irgsh-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

**irgsh-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    irgsh-cli. See **foo.conf**(5) for further details.
...
**irgsh-cli** provides some return codes, that can be used in scripts:
